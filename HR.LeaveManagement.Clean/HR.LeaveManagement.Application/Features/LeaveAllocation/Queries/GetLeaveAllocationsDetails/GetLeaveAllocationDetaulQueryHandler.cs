...
{
    public class GetLeaveAllocationDetaulQueryHandler : IRequestHandler<GetLeaveAllocationDetailQuery, LeaveAllocationDetailsDto>
    {
        private readonly ILeaveAllocationRepository _leaveAllocationRepository;
        private readonly IMapper _mapper;

        public GetLeaveAllocationDetaulQueryHandler(ILeaveAllocationRepository leaveAllocationRepository, IMapper mapper)
        {
