...
namespace HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20231219172640_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 12, 19, 18, 26, 40, 643, DateTimeKind.Local).AddTicks(5675),
                            DateModified = new DateTime(2023, 12, 19, 18, 26, 40, 643, DateTimeKind.Local).AddTicks(5713),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
